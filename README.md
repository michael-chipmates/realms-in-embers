...
**Free forever, open source, no accounts, no tracking.** Code: [AGPL-3.0](LICENSE), so nobody can take this game closed-source or sell it out from under its players. Fiction & art: [CC BY-SA 4.0](LICENSE-CONTENT). Music: Scott Buckley, CC-BY 4.0. Full attribution in [`CREDITS.md`](CREDITS.md).
