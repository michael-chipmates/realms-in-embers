...
export interface ArtifactFx {
  ...
  /** Order each season in the province where the bearer stands. */
  orderAura?: number;
  /** Emberlight each season. */
  emberlight?: number;
...
export const ARTIFACTS: Record<string, ArtifactDef> = {
  ...
  gravebiter: {
    ...
    desc: '+3 might. Cursed: −1 order each season wherever the bearer stands.',
  ...
  lanternOfTheLastWatch: {
    ...
    desc: '+2 leadership; +1 order each season where the bearer stands.',
  ...
  crownOfSmallCandles: {
    ...
    desc: '+3 leadership; +2 order each season where the bearer stands.',
  ...
  shardOfMorning: {
    ...
    desc: 'Saga shard. +2 Emberlight each season; +1 order where the bearer stands.',
  ...
  shardOfNoon: {
    ...
    flavor: 'It remembers the realm at its height, and seethes at being misremembered as modest.',
  },
  emberheart: {
    ...
    desc: 'The reforged heart of the Ember Throne. +2 might/lore/leadership, +3 Emberlight each season, +1 order where the bearer stands.',
