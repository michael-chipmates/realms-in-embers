...
export const TEACHINGS: Record<string, string> = {
  ...
  firstQuest:
    'Marginalia — on quests: the hero rolls their best relevant stat plus level and fortune against the difficulty. Triumph pays half again as much; disaster wounds, and at the bloodier tiers, kills. The board rotates each season. Precious things go to the bold — and the boldly prepared.',
  firstStrain:
