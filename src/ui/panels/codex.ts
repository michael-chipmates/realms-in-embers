...
export function openCodexOverlay(screen: GameScreen, anchor: CodexSection = 'battle'): void {
  ...
  const renderPage = (): void => {
    ...
    // the modal panel is the scroller, so a fresh chapter starts at its top
...
function renderEnchant(): HTMLElement {
  ...
  return h('div', {},
    ...
    fact('Harbor quarantine', 'Not magic, just misfortune. An event can close a port: −6 gold each season for 2 seasons.'),
